...
class Anim:
    ...
    @staticmethod
    def get_anim_graph_node_object_path(*, anim_blueprint_path, graph_name, node_guid):
        """X.get_anim_graph_node_object_path(anim_blueprint_path, graph_name, node_guid) -> str"""
        return unreal.UnrealBridgeAnimLibrary.get_anim_graph_node_object_path(anim_blueprint_path, graph_name, node_guid)
    ...
    @staticmethod
    def repair_imported_anim_sequence_tracks(*, sequence_paths, secondary_motion_bone_prefixes, convert_ue_anim_additive_scale):
        """X.repair_imported_anim_sequence_tracks(sequence_paths, secondary_motion_bone_prefixes, convert_ue_anim_additive_scale) -> Array[str]"""
        return unreal.UnrealBridgeAnimLibrary.repair_imported_anim_sequence_tracks(sequence_paths, secondary_motion_bone_prefixes, convert_ue_anim_additive_scale)
...
class Asset:
    ...
    @staticmethod
    def import_ui_textures(*, source_filenames, destination_path, replace_existing, save):
        """X.import_ui_textures(source_filenames, destination_path, replace_existing, save) -> Array[str]"""
        return unreal.UnrealBridgeAssetLibrary.import_ui_textures(source_filenames, destination_path, replace_existing, save)
...
class Editor:
    ...
    @staticmethod
    def conform_pie_viewport_size(*, width, height):
        """X.conform_pie_viewport_size(width, height) -> bool"""
        return unreal.UnrealBridgeEditorLibrary.conform_pie_viewport_size(width, height)
    ...
    @staticmethod
    def start_pie_in_new_window(*, width, height):
        """X.start_pie_in_new_window(width, height) -> bool"""
        return unreal.UnrealBridgeEditorLibrary.start_pie_in_new_window(width, height)
...
class Gameplay:
    ...
    @staticmethod
    def get_pawn_mesh_debug():
        """X.get_pawn_mesh_debug() -> Map[str, str]"""
        return unreal.UnrealBridgeGameplayLibrary.get_pawn_mesh_debug()
